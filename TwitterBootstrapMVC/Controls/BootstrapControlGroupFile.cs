...
{
    public class BootstrapControlGroupFile : BootstrapFile
    {
        public BootstrapControlGroupFile(HtmlHelper html, string htmlFieldName, ModelMetadata metadata)
        ...
        {
            return Renderer.RenderControlGroupFile(html, _model, null);
        }
